...
const About = () => {
  return (
    <div id='about' className=' relative w-full p-2 flex items-center py-16 bg-bg_image bg-cover bg-fixed'>
      <div className='py-20 px-2 w-full relative m-auto md:block grid-cols-3 gap-8 bg-[#00000091] border-double border-4 rounded-sm rounded-tl-[80px] rounded-br-[80px] border-red-'>
        <div className='col-span-3 leading-80'>
          ...
          <div className='scale-80 w-[40%] h-auto m-auto shadow-lg bg-white shadow-gray-700 rounded-xl flex items-center justify-center p-4 hover:scale-105 ease-in duration-300'>
          <Image src={PageSpeed} className='rounded-xl' alt='/' priority='true'/>
        </div>
...
<div className='scale-80 w-[40%] h-auto m-auto shadow-lg bg-white shadow-gray-700 rounded-xl flex items-center justify-center p-4 hover:scale-105 ease-in duration-300'>
          <Image src={Review} className='rounded-xl' alt='/' priority='true'/>
        </div>
<p className='mx-10 font-bold indent-7 leading-20 py-2 text-[#f5f5f5] my-4'>
...
<h2 className='text-[#f5f5f5] font-extrabold'>High Production Quality</h2>
          ...
          <div className='scale-80 w-[60%] bg-black h-auto m-auto shadow-xl shadow-[white] rounded-xl flex items-center justify-center p-4 hover:scale-105 ease-in duration-300'>
