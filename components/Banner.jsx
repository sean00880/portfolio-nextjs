    ...
    <div id='banner' className=' relative w-auto items-center m-2 border-4 border-white pt-8 bg-[#771d1d] rounded-2xl'>
      ...
      <div className='bg-bg_ad bg-cover bg-fixed bg-no-repeat w-auto lg:w-[30%] rounded-2xl p-4 bg-[#181a1882] border-2 border-double'><div className='bg-[#000000e3] w-full h-full text-center rounded-2xl border-double border-4 p-6'> <h2 className='text-center text-xl font-[900] text-[#549751] p-6 leading-20 shimmer'> Local Business? <hr /> Get an Enterprise Website Developed & Setup for only $99 down!</h2><br /><button className='p-3 m-3 border-4 '>Contact Us</button></div></div>
       ...
       <div className="flex-col m-5">
        ...
        <div className='flex flex-col text-red-700 text-center font-extrabold my-10'><Image src='https://i.ibb.co/3MDCjpX/contact.png' width={150} height={150} className='rounded-3xl'/><h3 className='my-10'>Initiate Contact for Quotation</h3></div> 
        <Image src='https://i.ibb.co/P9b4qFk/rightarrow.png' width={100} height={100} className='rounded-3xl'/>    
        <div className='flex flex-col text-red-700 text-center font-extrabold my-10'><Image src='https://i.ibb.co/YWFL0sM/quote-request.png' width={150} height={150} className='rounded-3xl'/><h3 className='my-10'>Process Order</h3></div> 
        <Image src='https://i.ibb.co/P9b4qFk/rightarrow.png' width={100} height={100} className='rounded-3xl'/>
        <div className='flex flex-col text-red-700 text-center font-extrabold my-10'><Image src='https://i.ibb.co/Qn4qQKR/website.png' width={150} height={150} className='rounded-3xl'/><h3 className='my-10'>Receive Delivered Product</h3></div> 
        </div>
        </div>
        </div>
