...
const Card2 = () => {
  return (
    <div className='flex leading-20 flex-col border-2 border-black  h-full w-full xl:h-[75vw] 2xl:h-[55vw] xl:w-[23vw] p-5 m-4 text-center text-black hover:scale-105 ease-in duration-300 bg-[#e4e3e3cd] mt-auto'>
    <h2 className='my-2 mt-auto'>Enterprise Website Build & Setup</h2><hr/>
