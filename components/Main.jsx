...
const Main = () => {
  return (
    <div id='home' className='pb-10 pt-[10vh] w-full h-auto text-center lg:bg-bg_image2 bg-cover bg-fixed border-b-4'>
      ...
      <h1 className='py-2 mt-10 pl-14 pr-14 leading-20 text-3xl text-[white] bg-[#c24a48] border-[3px] border-solid border-[#161616] text-center'><span className="text-[black] font-bold bg-white p-2 font-[23px]">
