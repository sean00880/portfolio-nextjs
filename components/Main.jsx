...
const Main = () => {
  return (
    <div id='home' className='pb-10 w-full h-auto xl:h-full text-center bg-bg_image10 lg:bg-bg_image2 bg-cover bg-fixed border-b-4'>
      <div className='px-3 justify-around leading-20 pt-40 md:pt-30 w-full mx-auto p-2 flex flex-col xl:flex-row items-center bg-[#1313139e]'>
      ...
      <h1 className='py-2 mt-10 pl-14 pr-14 leading-20 text-3xl text-[#e7e7e7] bg-[#252424]  text-center rounded-tl-[110px] rounded-br-[110px]'><span className="text-gray-200 font-bold pb-3">
        ...
        <h3 className='uppercase text-sm leading-20 tracking-widest bg-[black] text-[#d0d0d0] text-center my-3 rounded-lg'>
          ...
          <div className='p-3 mb-5 text-xl text-black font-bold rounded-xl bg-white'> <div className="bg-[#29282812] border-2 border-[#b62f43e8] rounded-2xl display md:display-block"> <h2 className='my-2 py-2 tracking-widest leading-20 text-[#282828] text-xl m-auto px-4 '>Web & Digital Services Offered by Talented Professionals</h2></div>Need assistance with Web or Web3 services? Check out <br /><span className="text-[#aa283c] text-2xl animate-bounce"><Link href='/services' passHref> offered services</Link>.</span> </div>
        ...
        <div className='mx-2 bg-[#000000a1] px-3 py-2 rounded-2xl w-full xl:w-[40%] lg:w-[60%]'><h3 className='my-10'>Featured Projects:</h3><ProjectItem
