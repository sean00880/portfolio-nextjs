...
const Main = () => {
  return (
    <div id='home' className='pb-10 pt-[10vh] w-full h-auto xl:h-[100vh] text-center bg-bg_image10 lg:bg-bg_image2 bg-cover bg-fixed border-b-4'>
      <div className='px-3 justify-around h-[211vh] xl:h-auto leading-20 py-50 sm:py-25 pb-[2rem] md:pt-30 w-full mx-auto p-2 flex flex-col xl:flex-row items-center radial3'>
