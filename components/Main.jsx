...
const Main = () => {
  return (
    <div id='home' className='pb-10 mt-[100%] sm:mt-[0] w-full h-auto xl:h-[100vh] text-center bg-bg_image10 lg:bg-bg_image2 bg-cover bg-fixed border-b-4'>
      <div className='px-3 justify-around h-[200vh] xl:h-auto leading-20 pt-[11rem] pb-[2rem] md:pt-30 w-full mx-auto p-2 flex flex-col xl:flex-row items-center radial3'>
