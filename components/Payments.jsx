...
const Payments = () => {
  ...
  return (
    <div id='services' className='relative w-full p-2 flex items-center py-16 pt-40 bg-bg_image3 bg-cover bg-fixed'>
      <div className='py-20 px-2 max-w-[1240px] mt-20 relative m-auto md:block grid-cols-3 gap-8 bg-bg_image8 bg-cover bg-fixed border-double border-4 rounded-sm rounded-tl-[80px] rounded-br-[80px] border-red-700'>
