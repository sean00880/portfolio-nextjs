...
const ProjectItem = ({title, backgroundImg, tech, projectUrl}) => {
  return (
    <div className='relative flex items-center justify-center border-4 border-inset border-[#ffffffe9] bg-[#000000f1] h-[60vh] w-full shadow-xl shadow-[#d9d9d9] rounded-xl group hover:bg-gradient-to-r from-[#e8e8ee] to-[#991830] '>
