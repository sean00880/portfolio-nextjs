...
const contact = () => {
  ...
  return (
    <>
      ...
      <Navbar />
    <div id='contact' className='pt-60 w-full pb-[20px] bg-[#f1f1f1] bg-bg_image11 bg-contain bg-center bg-no-repeat bg-fixed'>
      <div className='max-w-[1240px] py-20 mx-auto flex flex-col justify-center bg-[#c7b7baf7] border-double border-2 rounded-sm border-gray-800' >
