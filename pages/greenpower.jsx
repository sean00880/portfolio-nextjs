...
import grllc from '../public/assets/projects/greenpower.png';
      ...
      <div className=' text-center max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
        <div className='col-span-4 md:col-span-3 lg:col-span-4'>
          ...
          <p className='mt-2 text-left'>
            This is a portotype landscaping project with enhanced on-page SEO features. It utilizes dynamic page routes in order to make the best use onpage SEO features offered by Next.JS. <br></br><br></br> By including the services in the hero section, the website captures user attention as soon as they enter the website. The websites features a unique and modern User Interface design and provides for a high quality and interactive UX experience. The services component is segmented into different sections. Each category and service has its own page, which allows for search engines to crawl through your website much more efficiently and display valuable information to your users. 
           </p>
          <a
